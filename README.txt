...
Запуск: 
1) запустить скрипт ./install.sh (запуска и по потребности установки)
...
В корневой директории с docker-compose.yml (должен быть установлен docker и docker-compose в дистрибутив unix системы) 